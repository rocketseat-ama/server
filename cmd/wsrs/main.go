...
import (
	...
	"github.com/rocketseat-ama/server/internal/api"
...
func main() {
	...
	// before returning function response, closes connections pool
	defer pool.Close()
	...
	quit := make(chan os.Signal, 1) // receive signals from os
